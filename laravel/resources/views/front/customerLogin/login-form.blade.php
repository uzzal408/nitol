    ...
    <div id="logreg-forms">
        <form class="form-signin" action="{{ route('customer.login') }}" method="POST">
           @csrf
            ...
            <button class="btn btn-primary btn-block" type="button" onclick="window.location='{{ route("customer.registration-form") }}'"><i class="fas fa-user-plus"></i> Sign up New Account</button>
        </form>
