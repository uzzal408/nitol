                ...
                <div class="wrap-product-detail">
                    <div class="detail-media">
                        <div class="product-gallery"><br>
                            ...
                            <img class="xzoom" id="xzoom-default" src="<?php echo e(asset($product->image1)); ?>" xoriginal="<?php echo e(asset($product->image1)); ?>" />
                                <div class="xzoom-thumbs">
                                    <?php if($product->image1): ?>
                                        <a href="<?php echo e(asset($product->image1)); ?>"><img class="xzoom-gallery" width="80" src="<?php echo e(asset($product->image1)); ?>"  xpreview="<?php echo e(asset($product->image1)); ?>" title="<?php echo e($product->title); ?>"></a>
                                    <?php endif; ?>
                                    <?php if($product->image2): ?>
                                        <a href="<?php echo e(asset($product->image2)); ?>"><img class="xzoom-gallery" width="80" src="<?php echo e(asset($product->image2)); ?>" title="<?php echo e($product->title); ?>"></a>
                                    <?php endif; ?>
                                    <?php if($product->image3): ?>
                                        <a href="<?php echo e(asset($product->image3)); ?>"><img class="xzoom-gallery" width="80" src="<?php echo e(asset($product->image3)); ?>" title="<?php echo e($product->title); ?>"></a>
                                    <?php endif; ?>
                                    <?php if($product->image4): ?>
                                        <a href="<?php echo e(asset($product->image4)); ?>"><img class="xzoom-gallery" width="80" src="<?php echo e(asset($product->image4)); ?>" title="<?php echo e($product->title); ?>"></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <?php else: ?>
                                ...
                                <div class="radio">
                                    <?php if( $product_price>=10000): ?>
                                        ...
                                        <label><input type="radio" name="optradio" onclick="emiAmount(<?php echo e($product_price); ?>,9)">9 Month</label>

                                        <label><input type="radio" name="optradio" onclick="emiAmount(<?php echo e($product_price); ?>,12)">12 Month</label>
                                    <?php endif; ?>
                                    
                                </div>
                                
                                <?php if($product_price >10001): ?>

                                    <div class="stock-info in-stock">
                                        <p class="availability">Installment:
                                            <b id="installmentAmount">
                                                <?php echo e(number_format($product_price/3),2); ?> BDT/Month
                                            </b>
                                        </p>
                                    </div>
                                <?php endif; ?>
                                ...
                                <div class="wrap-butons">
                                    ...
                                    <?php elseif($product->sale_price>0): ?>
                                        <input type="hidden" name="product_price" value="<?php echo e($product->sale_price); ?>" min="1">
                                    <?php else: ?>
