                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                        <div class="wrap-footer-item">
                            ...
                            <div class="item-header"><span><a href="<?php echo e(route('front.download.brotuiar')); ?>" target="_blank"> Dowload Brushier/<br>Catalogue</a> </span></div>
                        </div>
                    </div>
        ...
        <div class="coppy-right-box">
            <div class="container">
                <div class="coppy-right-item item-left">
                    <p class="coppy-right-text">Copyright © <?php echo e(date('Y')); ?> <a href="#" class="link-to-home">Nitol</a>. All rights reserved</p>
                </div>
