            ...
            <?php echo e(Form::open(['route'=>'save-order','class'=>'contact-form','method'=>'POST','name'=>'frm-billing'])); ?>
                ...
                <div class="wrap-address-billing">
                    ...
                    <p class="row-in-form">
                        ...
                        <input id="fname" type="text" name="fname" value="<?php echo e(isset($customerShoppingDetail->first_name) ? $customerShoppingDetail->first_name : ''); ?>" placeholder="Your name" required>
                    </p>
                    <p class="row-in-form">
                        <label for="lname">last name<span>*</span></label>
                        <input id="lname" type="text" name="lname" value="<?php echo e(isset($customerShoppingDetail->last_name) ? $customerShoppingDetail->last_name : ''); ?>" placeholder="Your last name" required>
                    </p>
                    <p class="row-in-form">
                        <label for="email">Email Addreess:</label>
                        <input id="email" type="email" name="email" value="<?php echo e(isset($customerShoppingDetail->email) ? $customerShoppingDetail->email : ''); ?>" placeholder="Type your email">
                    </p>
                    <p class="row-in-form">
                        <label for="phone">Phone number<span>*</span></label>
                        <input id="phone" type="text" name="phone" value="<?php echo e(isset($customerShoppingDetail->phone) ? $customerShoppingDetail->phone : ''); ?>" placeholder="11 digits format" required>
                    </p>
                    <p class="row-in-form">
                        <label for="add">Address:<span>*</span></label>
                        <input id="add" type="text" name="add" value="<?php echo e(isset($customerShoppingDetail->address) ? $customerShoppingDetail->address : ''); ?>" placeholder="Street at apartment number" required>
                    </p>
                    <p class="row-in-form">
                        <label for="country">Country<span>*</span></label>
                        <input id="country" type="text" name="country" value="<?php echo e(isset($customerShoppingDetail->country) ? $customerShoppingDetail->country : ''); ?>" placeholder="United States" required>
                    </p>
                    <p class="row-in-form">
                    ...
                    <p class="row-in-form">
                        ...
                        <input id="city" type="text" name="city" value="<?php echo e(isset($customerShoppingDetail->town) ? $customerShoppingDetail->town : ''); ?>" placeholder="City name" required>
                    </p>
