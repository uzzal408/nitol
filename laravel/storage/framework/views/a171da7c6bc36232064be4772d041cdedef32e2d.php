            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="row form-bg-st" >
                        ...
                        <?php echo e(Form::open(['route'=>'corporateSalesStore','class'=>'text-center border','method'=>'POST','name'=>'frm-billing'])); ?>
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <!-- First name -->
                                    <div class="<?php echo e($errors->first('full_name',' has-error')); ?>">
                                        ...
                                        <div class="text-danger"><?php echo e($errors->has('full_name') ? $errors->first('full_name') : ''); ?></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <!-- Last name -->
                                    <div class="<?php echo e($errors->first('company_name',' has-error')); ?>">
                                        ...
                                        <div class="text-danger"><?php echo e($errors->has('company_name') ? $errors->first('company_name') : ''); ?></div>
                                    </div>
                                </div>
                            </div>
                            <!-- Phone number -->
                            <div class="col-md-6">
                                <div class="<?php echo e($errors->first('contact_number',' has-error')); ?>">
                                    ...
                                    <div class="text-danger"><?php echo e($errors->has('contact_number') ? $errors->first('contact_number') : ''); ?></div>
                                </div>
                            </div>
                            <!-- E-mail -->
                            <div class="col-md-6">
                                <div class="<?php echo e($errors->first('email_address',' has-error')); ?>">
                                    ...
                                    <div class="text-danger"><?php echo e($errors->has('email_address') ? $errors->first('email_address') : ''); ?></div>
                                </div>
                            </div>
        
                            <!-- Addres -->
                            <div class="col-md-6">
                                <div class="<?php echo e($errors->first('address',' has-error')); ?>">
                                    ...
                                    <div class="text-danger"><?php echo e($errors->has('address') ? $errors->first('address') : ''); ?></div>
                                </div>
                            </div>
        
                            <!-- city -->
                            <div class="col-md-3">
                                <div class="<?php echo e($errors->first('city',' has-error')); ?>">
                                    <label class="control-label" for="inputSuccess1">City</label>
                                    <input type="text" class="form-control" name="city" placeholder="City" required>
                                    <div class="text-danger"><?php echo e($errors->has('city') ? $errors->first('city') : ''); ?></div>
                                </div>
                            </div>
    
                            <!-- city -->
                            <div class="col-md-3">
                                <div class="<?php echo e($errors->first('country',' has-error')); ?>">
                                    <label class="control-label" for="inputSuccess1">Country</label>
                                    <input type="text" class="form-control" name="country" placeholder="Country">
                                    <div class="text-danger"><?php echo e($errors->has('country') ? $errors->first('country') : ''); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="<?php echo e($errors->first('inlineRadioOptions',' has-error')); ?>">
                                    ...
                                    <div class="text-danger"><?php echo e($errors->has('inlineRadioOptions') ? $errors->first('inlineRadioOptions') : ''); ?></div>
                                </div>
                                    
                                <div class=" col-md-4 col-xs-12">
                                    <div class="<?php echo e($errors->first('category',' has-error')); ?>">
                                        ...
                                        <div class="text-danger"><?php echo e($errors->has('category') ? $errors->first('category') : ''); ?></div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6" style="position:static !important">
                                <div class="<?php echo e($errors->first('enquiry',' has-error')); ?>">
                                    ...
                                    <div class="text-danger"><?php echo e($errors->has('enquiry') ? $errors->first('enquiry') : ''); ?></div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <!-- Sign up button -->
