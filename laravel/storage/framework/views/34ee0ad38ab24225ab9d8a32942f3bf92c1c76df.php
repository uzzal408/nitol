    ...
    <div class="container">
        <div class="row">
            ...
            <div class="summary-item payment-method">
                    <button type="submit" class="btn btn-medium"><a title="Edit Prifile" href="<?php echo e(url('')); ?>/customerProfileEdit/<?php echo e(Auth::guard('customer')->user()->id); ?>" style="color:white">Edit Profile</a></button>
            </div>
        </div><!--end row-->
