                ...
                <div class="container">
                    ...
                    <div class="topbar-menu right-menu">
                        <ul>
                            ...
                            <li class="menu-item" ><a title="Dealer Location" href="<?php echo e(url('')); ?>/dealer/locator">Dealer Locator</a></li>
                                ...
                                <div class="wrap-megamenu">
                                    <div class="megamenu-content min-height-526 bg-menu-refrigerator">
                                        <div class="row">
                                                        ...
                                                        <?php $__currentLoopData = $allCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <?php if($category['name']=='REFRIGERATOR & FREEZERS'): ?>
                                                                ...
                                                                <?php if(isset($category['children'])): ?>
                                                                    ...
                                                                    <?php $__currentLoopData = $category['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php if($subcategory['name']=='REFRIGERATOR'): ?>
                                                                            <?php if(isset($subcategory['children'])): ?>
                                                                                <?php $__currentLoopData = $subcategory['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subSubcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                    <li class="menu-item"><a href="<?php echo e(url('')); ?>/products/<?php echo e($subSubcategory->id); ?>" class="link-term"><?php echo e($subSubcategory->name); ?></a></li>
                                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="custom-col-5">
                                                <div class="wrap-vertical-nav">
                                                    <h2 class="menu-title">FREEZERS</h2>
                                                    <ul>
                                                        <?php $__currentLoopData = $allCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <?php if($category['name']=='REFRIGERATOR & FREEZERS'): ?>
                                                                ...
                                                                <?php if(isset($category['children'])): ?>
                                                                    ...
                                                                    <?php $__currentLoopData = $category['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php if($subcategory['name']=='FREEZERS'): ?>
                                                                            <?php if(isset($subcategory['children'])): ?>
                                                                                <?php $__currentLoopData = $subcategory['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subSubcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                    <li class="menu-item"><a href="<?php echo e(url('')); ?>/products/<?php echo e($subSubcategory->id); ?>" class="link-term"><?php echo e($subSubcategory->name); ?></a></li>
                                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <ul>
                    <li class="fc-info-item">
                        ...
                        <div class="wrap-left-info">
                            ...
                            <p class="fc-desc">
                                <?php $__currentLoopData = $allCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                                    <?php if($category['name']=='Free Shipping Cost'): ?> 
                                        <?php
                                            $free_shipping = explode(',',$category['description']) 
                                        ?>
                                        Free On Oder Over <?php echo e($free_shipping[0]); ?>
        ...
        <div class="main-footer-content">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-4 col-md-4 col-xs-12 box-twin-content">
                        <div class="row">
                ...
                <div class="row">
                        ...
                        <div class="wrap-footer-item">
                            ...
                            <div class="item-content">
                                <div class="wrap-list-item wrap-gallery">
                                    <ul>
                                        <li><a href="#" class="link-to-item"><figure><img src="<?php echo e(asset('/')); ?>client_end/images/bkash.png" alt="american express"></figure></a></li>
                                        <li><a href="#" class="link-to-item"><figure><img src="<?php echo e(asset('/')); ?>client_end/images/SCB.png" alt="paypal"></figure></a></li>
                                        <li><a href="#" class="link-to-item"><figure><img src="<?php echo e(asset('/')); ?>client_end/images/AmEx.png" alt="paypal"></figure></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="wrap-footer-item">
                            ...
                            <div class="item-content">
                                <div class="wrap-list-item social-network">
                                    <ul>
                                        <li><a href="https://www.facebook.com/nitolelectronics/" class="link-to-item" title="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                        <li><a href="https://www.instagram.com/atashii_nitol_electronics/" class="link-to-item" title="instagram"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                                        <li><a href="https://www.youtube.com/channel/UCNWBbN6gtqtHO4JuAlSTqDg" class="link-to-item" title="youtube"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
                    ...
                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                        <div class="wrap-footer-item">
                            <h3 class="item-header"><span> Dowload App </span></h3><span style="margin-left:175px;"> Marketed by</span>
                            
                            <div class="item-content">
                                <div class="wrap-list-item apps-list">
                                    <ul>
                                        <li><a href="#" class="link-to-item" title="our application on apple store"><figure><img src="<?php echo e(asset('/')); ?>client_end/images/brands/apple-store.png" alt="apple store" width="128" height="36"></figure></a></li>
