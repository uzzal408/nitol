        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <?php echo $__env->make('admin.includes.common-error', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <!-- form start -->
                <?php echo e(Form::open(['route'=>'update-product','class'=>'contact-form','method'=>'POST','name'=>'newProduct','files' => true])); ?>
                ...
                <div class="box-body">
                    <div class="<?php echo e('form-group required'.$errors->first('name',' has-error')); ?>">
                        ...
                        <?php echo e(Form::text('title',$product->title ,array('id' => 'title', 'required' => 'required', 'placeholder' => 'Enter Product Title', 'class' => 'form-control '))); ?>
                        ...
                        <?php else: ?>
                            <div class="row">
                                <?php $__currentLoopData = $specifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div>
                                        <div class="col-md-8">
                                            <input type="text" value="<?php echo e($category); ?>" id="add_button" name="specifications[]" class="form-control" autocomplete="on">
                                        </div>
                                    </div>
                    ...
                    <div class="form-group" id="#">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <?php echo e(Form::number('ac_capacity',$product->ac_capacity,array('id' => 'ac_capacity', 'class' => 'form-control ', 'step'=>0.5, 'min'=>1, 'max'=>20))); ?>

                            </div>
                            <div class="col-md-4">
                                <label>Screen Size</label>
                                <?php echo e(Form::number('screen_size',$product->screen_size,array('id' => 'screen_size', 'class' => 'form-control ', 'step'=>0.5, 'min'=>1, 'max'=>200))); ?>

                            </div>
                            
                            <div class="col-md-4">
                                <label>Refrezarator Capacity</label>
                                <?php echo e(Form::number('capacity_litre',$product->capacity_litre,array('id' => 'capacity_litre', 'class' => 'form-control ', 'step'=>0.5, 'min'=>1, 'max'=>20000))); ?>
                    ...
                    <div class="form-group" id="#">
                        <div class="row">
                            <div class="col-md-3">
                                <label>Price</label>
                                <?php echo e(Form::number('price',$product->price,array('id' => 'price', 'class' => 'form-control ', 'min'=>1, 'max'=>5000000))); ?>

                            </div>

                            <div class="col-md-3">
                                <label>Sale Price</label>
                                <?php echo e(Form::number('sale_price',$product->sale_price,array('id' => 'sale_price', 'class' => 'form-control ', 'min'=>1, 'max'=>5000000))); ?>

                            </div>

                            <div class="col-md-3">
                                <label>Discount</label>
                                <?php echo e(Form::number('discount',$product->discount,array('id' => 'discount', 'class' => 'form-control ', 'min'=>0, 'max'=>90, 'step'=>0.01))); ?>

                            </div>
                            
                            <div class="col-md-3">
                                <label>Stock Quantity</label>
                                <?php echo e(Form::number('quantity',$product->quantity,array('id' => 'quantity', 'class' => 'form-control ', 'min'=>1, 'max'=>500000))); ?>
                    ...
                    <div class="form-group">
                        ...
                        <?php echo e(Form::textarea('description',$product->description,array('id' => 'description', 'rows'=> '3', 'placeholder' => 'Enter Description of Your Product', 'class' => 'form-control description'))); ?>
                            ...
                            <div class="row">
                                <?php $__currentLoopData = $additional_informations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $additional_information): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $__currentLoopData = $additional_information; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div>
                                            <div class="col-md-5">
                                                <input type="text" value="<?php echo e($key); ?>" name="adInfo_ids[]" class="form-control" autocomplete="on">
                                            </div>
                                            <div class="col-md-5">
                                                <input type="text" value="<?php echo e($value); ?>" name="adInfo_values[]" class="form-control" autocomplete="on">
                                            </div>
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="form-check">
                                <label class="form-check-label" for="<?php echo e($category->id); ?>">
                                    <?php echo e(Form::checkbox('category_ids[]', $category->id, in_array($category->id,$product_category_ids)?'checked':'', array('id'=>$category->id))); ?>
                                    ...
                                    <?php $__currentLoopData = $category->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="form-check" style="margin-left: 15px;">
                                            <label class="form-check-label" for="<?php echo e($subcategory->id); ?>">
                                                <?php echo e(Form::checkbox('category_ids[]', $subcategory->id, in_array($subcategory->id,$product_category_ids)?'checked':'', array('id'=>$subcategory->id))); ?>
                                                ...
                                                <?php $__currentLoopData = $subcategory->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subsubcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="form-check" style="margin-left: 15px;">
                                                        <label class="form-check-label" for="<?php echo e($subsubcategory->id); ?>">
                                                            <?php echo e(Form::checkbox('category_ids[]', $subsubcategory->id, in_array($subsubcategory->id,$product_category_ids)?'checked':'', array('id'=>$subsubcategory->id))); ?>
