<?php $__env->startSection('stylesheet'); ?>
    <link href="<?php echo e(asset('/')); ?>client_end/css/styleMobile.css" rel="stylesheet">
    <style>

        body {
            background-image: url(<?php echo e(asset('/')); ?>front/assets/imgs/Backdrop.jpg);
                                                ...
                                                <div class="login_wrapper">
                                                    <div class="input_field">
                                                        <div class="input-group mb-3 col-12" style="">
                                                            ...
                                                            <?php echo e(Form::open(['route'=>'login-customer-by-email','class'=>'contact-form','method'=>'POST','name'=>'loginCustomerByEmail'])); ?>

                                                            <div class="container">

                                                                    <label for="uname"><b>Username</b></label>
                                                                    <?php echo e(Form::email('email_address','',array('required' => 'required', 'placeholder' => 'Your Email Address', 'id' => 'emailAddress'))); ?>

                                                                    <div class="invalid-feedback"><?php echo e($errors->has('email_address') ? $errors->first('email_address') : ''); ?></div>
                                                                    <div id="res"></div>
                                                                    

                                                                    <label for="psw"><b>Password</b></label>
                                                                    <?php echo e(Form::password('password',array('required' => 'required', 'placeholder' => 'Your Password'))); ?>

                                                                    <div class="invalid-feedback"><?php echo e($errors->has('password') ? $errors->first('password') : ''); ?></div>
                                                                    <label>
                                                        ...
                                                        <?php echo e(Form::open(['route'=>'login-customer-by-mobile','class'=>'contact-form','method'=>'POST','name'=>'loginCustomerByMobile'])); ?>
                                                        ...
                                                        <p>Create a new account <a href="<?php echo e(route('register-customer')); ?>" style="color:dodgerblue">SignUp</a>.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
